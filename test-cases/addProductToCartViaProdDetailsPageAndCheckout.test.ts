...
test('e2e-Add Product to Cart from product details page and checkout', { tag: '@Smoke'}, async ({ loginPage, commonPage, homePage, yourCartPage, yourInformationPage,checkoutPage }) => {
    ...
    await test.step('Open product details, add to cart and click on shopping link.', async () => {
